...
CREATE TABLE users_aydenc16(
  username VARCHAR(20) PRIMARY KEY,
  password VARBINARY(144) NOT NULL,
  balance INT NOT NULL
);

CREATE TABLE reservations_aydenc16(
  username VARCHAR(20) FOREIGN KEY REFERENCES users_aydenc16(username),
  rid INT PRIMARY KEY,
  isPaid INT NOT NULL,
  flight1 INT FOREIGN KEY REFERENCES FLIGHTS(fid) NOT NULL,
  flight2 INT FOREIGN KEY REFERENCES FLIGHTS(fid)
);
